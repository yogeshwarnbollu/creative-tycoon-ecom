        ...
        <div class="shopping-cart"> 
          ...
          <div class="cart-ship-info">
            <div class="row"> 
              ...
              <div class="col-sm-7">
                <h6>OTP has send to your email id</h6>
                  ...
                  <ul class="row">
                    ...
                    <li class="col-md-6">
                      <label>Enter OTP <br>
                        <input type="text" name="email_id"  placeholder=" Enter One Time Password">
                      </label>
                    </li>
                    ...
                    <!-- LOGIN -->
                    <li class="col-md-12">
                      <a href="comfipass.php"><button class="btn">SUBMIT</button></a>
                    </li>
                    </form>
