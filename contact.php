...
$message = mysqli_real_escape_string($con, trim(($_POST["message"])));
 ...
 $sql="INSERT INTO contact_us (name,email,contact,subject,message,d_o_c,t_o_c) VALUES ('$name','$email','$contact','$subject','$message','$d_o_c','$t_o_c');";
          ...
          <div class="row">
            <div class="col-md-8"> 
              ...
              <form action="" method="post">
                <ul class="row">
                  ...
                  <li class="col-sm-6">
                    <label>Phone *
                      <input type="text" class="form-control" name="contact" id="company" placeholder="" required>
                    </label>
                  </li>
                  <li class="col-sm-6">
                    <label>SUBJECT
                      <input type="text" class="form-control" name="subject" id="website" placeholder="" required>
                    </label>
                  </li>
                  <li class="col-sm-12">
                    <label>Message
                      <textarea class="form-control" name="message" id="message" rows="5" maxlength="250" placeholder="250 chars only" required></textarea>
                    </label>
                  </li>
                  <li class="col-sm-12">
                    <button type="submit" name="submit_c" class="btn" id="btn_submit" >SEND </button>
                  </li>
                </ul>
              </form>
            </div>
            ...
            <div class="col-md-4">
              <div class="contact-info">
                <h6>OUR ADDRESS</h6>
                <ul>
                  <li> <i class="icon-map-pin"></i> 1913, New Paccha Peth,<br>
                    Opposite to Government Polytechnique Collage <br> Solapur - 413005</li>
                  <li> <i class="icon-call-end"></i>+91 9822213849 <br>( 10 am to 9 pm IST throughout the week )</li>
                  <li> <i class="icon-envelope"></i> <a href="#" target="_top">contact@creativetycoon.in</a> </li>
                  <li> <i class="icon-social-facebook"></i> <a href="#" target="_top">creativetycoon</a> </li>
