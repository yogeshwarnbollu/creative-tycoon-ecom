...
?>
  ...
  <section class="sub-bnr" data-stellar-background-ratio="0.5">
    <div class="position-center-center">
      <div class="container">
        <h4><?php echo $cat_n ?> SUB CATEGORIES</h4>
      ...
      <div class="container">
        ...
        <!-- Popular Item Slide -->
          ...
          <div class="category-container">
           ...
           <?php
               $res=mysqli_query($con,"select * from sub_category where category='$cat_n'");

if(isset($_GET['search']))
{
  $see=$_GET['search'];
      $res=mysqli_query($con,"select * from sub_category where category='$cat_n' and search_tags LIKE '%{$see}%'");
}
...
echo ' 
      <div class="catag">
      <a href="shop.php?subcat='.$row['sub_category'].'">
        <div class="catag-img">
