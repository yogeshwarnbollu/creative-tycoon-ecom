...
$descn = mysqli_real_escape_string($con, trim($_POST["descn"]));
...
$newfilename="";
 ...
 $sql="INSERT INTO custom_gift (file_upload,title,descn,email_id,d_o_c,t_o_c) VALUES ('$newfilename','$title','$descn','".$_SESSION['main_user_id']."','$d_o_c','$t_o_c');";
...
?>
  ...
  <div id="content"> 
     <div class="heading text-center">
          <h3> MAKE YOUR OWN CUSTOMIZED GIFT WITH US</h3>
        </div>
...
<form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input style="padding: 10px 10px; color: #fff; margin-top: 0px;" onchange="ValidateSize(this.id)"  type="file" id="file" name="img_upload" />
                    <div id="uploadPreview">

                    </div>

                    <!-- <input style="padding: 10px 10px; color: #fff;" type="file" id="file"/>
                  ...
                  <div class="col-md-6">
                    <h6>DESCRIBE Yoyr Gift</h6>
                    <input  style="width: 100%; padding:8px;" type="text" name="title" placeholder="Gift Title">
                    <textarea name="descn" style=" margin-top: 20px;   width: 100%;
    height: 150px;
    padding: 10px;" placeholder="Explain your Gift......" required></textarea>
                  </div>
              ...
              <div class="col-md-12 text-center"><br><br>
                <button class="btn" type="submit" name="sub_r">Go To Cart</button>
              </div>
            </div> 
            </form>
